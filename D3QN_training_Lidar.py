...
LEFT = 2                # front left camera ID
RIGHT = 1               # front right camera ID
CENTER = 0              # front center camera ID
...
def trainNetwork():
    ...
    # set left front and right front camera angle
    ...
    while episode < MAX_EPISODE:
        ...
        starting_points, starting_direction = get_next_starting_point(client, road_points)
