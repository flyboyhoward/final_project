...
def trainNetwork():
    ...
    while episode < MAX_EPISODE:
        ...
        while not reset:
            ...
            print(x_val,y_val)
            print('####################################')
            if -136<x_val<137 and -136<y_val<137:
                reset = False
        ...
        if (episode % 5 == 0):
            trainable_saver.save(sess, "D:\\finalproject\\Obstacle-Avoidance-in-AirSim\\saved_networks\\new_model\\Simply_maze",global_step=episode,write_state=True)
