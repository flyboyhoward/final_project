...
def image_auxiliary(car_control):
    ...
    if flag1 == '1\n':
        ...
        car_control.steering = float(flag2)
...
def testNetwork(client, start_position, terminal_position):
    ...
    nmap, road_points, path_in_list, path_in_environment = turn.init_path_planning(start_position, terminal_position)
    ...
    while not reset:
        ...
        # turn control
        reset = turn.execute_turns(client, nmap, road_points, path_in_list, path_in_environment)
...
if __name__ == "__main__":
    ...
    # nmap, road_points, path_in_list, path_in_environment = turn.init_path_planning([13,13],[0,10])
    testNetwork(client, [13,13], [0,26])
